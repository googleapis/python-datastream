...
def test_discover_connection_profile(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = datastream.DiscoverConnectionProfileResponse(
            oracle_rdbms=datastream_resources.OracleRdbms(oracle_schemas=[datastream_resources.OracleSchema(schema='schema_value')]),
        )
...
def test_get_stream(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = datastream_resources.Stream(
            ...
            backfill_all=datastream_resources.Stream.BackfillAllStrategy(oracle_excluded_objects=datastream_resources.OracleRdbms(oracle_schemas=[datastream_resources.OracleSchema(schema='schema_value')])),
        )
...
def test_get_stream_object(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_stream_object),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_lookup_stream_object(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lookup_stream_object),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = datastream_resources.StreamObject(
            name='name_value',
...
def test_list_stream_objects_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, datastream_resources.StreamObject)
                   for i in results)
...
def test_start_backfill_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_backfill_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_stop_backfill_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_backfill_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_stream_object_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = datastream_resources.StreamObject.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_stream_object_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_get_stream_object") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_get_stream_object") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_lookup_stream_object_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_lookup_stream_object") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_lookup_stream_object") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_stream_objects_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = datastream.ListStreamObjectsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_stream_objects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_list_stream_objects") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_list_stream_objects") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_start_backfill_job_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = datastream.StartBackfillJobResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_start_backfill_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_start_backfill_job") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_start_backfill_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_stop_backfill_job_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = datastream.StopBackfillJobResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_stop_backfill_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DatastreamRestInterceptor, "post_stop_backfill_job") as post, \
         mock.patch.object(transports.DatastreamRestInterceptor, "pre_stop_backfill_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
